"""
Django settings for terbits_38258 project.
...
ROOT_URLCONF = 'terbits_38258.urls'
...
WSGI_APPLICATION = 'terbits_38258.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "terbits_38258 API",
    "DESCRIPTION": "API documentation for terbits_38258 App",
    "VERSION": "v1",
}
