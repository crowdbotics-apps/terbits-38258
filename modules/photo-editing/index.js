...
const PhotoEditing = ({
  ...
  return <Provider store={store} style={_styles.YwaemULc}>
      <App />
    <View style={_styles.smKazFVm}><ImageBackground style={_styles.oDMocTeD} source={{
      ...
      }} resizeMode="cover"></ImageBackground></View><Slider style={_styles.VFOsokvJ} thumbStyle={{
      height: 20,
      width: 20
    }} thumbTintColor="#0000FF" maximumValue={1} minimumValue={0}></Slider><View style={_styles.XIQMjzdR}></View><View style={_styles.VLFIZRLh}></View><View style={_styles.oaZQwmjl}></View><Pressable onPress={() => navigation.navigation.navigate("undefined", {})}><View style={_styles.AyLTKcpA}></View></Pressable></Provider>;
};
